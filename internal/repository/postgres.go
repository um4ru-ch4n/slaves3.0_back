...
func CreateSchema(db *pgx.Conn) error {
	_, err := db.Exec(context.Background(),
        ...
        (
            ...
            last_update timestamp with time zone NOT NULL DEFAULT '1971-11-03T00:00:00.0000+03:00'::timestamp,
            job_name character varying(255) NOT NULL DEFAULT '',
            user_type integer NOT NULL DEFAULT 1,
            slave_level integer NOT NULL DEFAULT 0,
            money_quantity bigint NOT NULL DEFAULT 0,
            defender_level integer NOT NULL DEFAULT 0,
            damage_quantity bigint NOT NULL DEFAULT 0,
            purchase_price_sm bigint NOT NULL DEFAULT 20,
            purchase_price_gm integer NOT NULL DEFAULT 0,
